...
class Dictionary{
    ...
    Dictionary* next[26];
    int count;
    void help(Dictionary* t,string s,vector<pair<string,int>> &v);

    public:
    Dictionary();
    void insert(Dictionary* dict,string &s);
    vector<pair<string,int>> wordsuggestion(Dictionary* dict,string &s);
